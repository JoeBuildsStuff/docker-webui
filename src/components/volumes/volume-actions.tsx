...
export function VolumeActions({ name }: VolumeActionsProps) {
  ...
  async function handleRemove() {
    ...
    // Simulate API call
    setTimeout(() => {
      toast.success("Volume removed successfully for " + name)
      setLoading(false)
    }, 1000)
  }
      ...
      <AlertDialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to remove this volume? This action cannot be undone and all data in the volume will
              be lost.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
